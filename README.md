[![Run App Ben Faubel](https://github.com/bfaubel/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/bfaubel/GithubActions/actions/workflows/run-app.yaml)
